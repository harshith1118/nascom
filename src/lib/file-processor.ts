...
export async function processFile(file: File): Promise<string> {
  ...
  try {
    ...
    // Sanitize the content to prevent XSS before returning
    return cleanForDisplay(content);
  } catch (error) {
  ...
  return new Promise((resolve, reject) => {
    ...
    reader.onload = async () => {
      try {
        ...
        // Sanitize the extracted text to prevent XSS
        resolve(cleanForDisplay(fullText));
      } catch (error) {
  ...
  return new Promise((resolve, reject) => {
    ...
    reader.onload = async () => {
      try {
        ...
        // Sanitize the extracted text to prevent XSS
        resolve(cleanForDisplay(result.value));
      } catch (error) {
  ...
  return new Promise((resolve, reject) => {
    ...
    reader.onload = () => {
      try {
        ...
        // Sanitize the extracted content to prevent XSS
        resolve(cleanForDisplay(content));
      } catch (error) {
